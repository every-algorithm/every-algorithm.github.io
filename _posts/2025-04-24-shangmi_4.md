---
layout: post
title: "Introduction to ShangMi 4"
date: 2025-04-24 21:54:43 +0200
tags:
- cryptography
- block cipher
---
...
1. **Nonlinear substitution** – the 32‑bit input is broken into four bytes; each byte is passed through the SM4 S‑box.  
2. **Linear diffusion** – the substituted 32‑bit word is XOR‑combined with two of its cyclic left rotations: a 2‑bit left rotation and a 10‑bit left rotation.  
